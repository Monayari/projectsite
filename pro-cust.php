            ...
            <div class="col-lg-12">
                <div class="card z-card p-2 mt-2 shadow border-0">
                    ...
                    <div class="card-header border-0 text-center">
                        <h6 class="card-title" style="color: #13adb5; font-size: 19px;"> پروفایل مشتری </h6>
                    </div>
                    <div class="card-body">
                        ...
                        <div class="row d-flex justify-content-around my-lg-4 my-3" style="font-size: 14px; font-weight: 500;">
                            ...
                            <div class="col-lg-4 d-flex justify-content-center my-3">
                                <span class="text-info"> نام خانوادگی : </span>
                        ...
                        <div class="row d-flex justify-content-around " style="font-size: 14px; font-weight: 500;">
                            <div class="col-lg-4  d-flex justify-content-center">
                                <span class="text-info"> ایمیل : </span>
                                <span> <?php echo $row['email']; ?> </span>
                            </div>
                            <div class="col-lg-4 d-flex justify-content-center my-3">
                                <span class="text-info"> جنسیت : </span>
                                <span> <?php echo $user->getSex($row['gender']); ?> </span>
                            </div>
                            <div class="col-lg-4 d-flex justify-content-center">
                                <span class="text-info"> سن : </span>
                            ...
                            <div class="row" style="font-size: 14px; font-weight: 500;">
                                ...
                                <span class="text-info"> نوع کاربری : </span>
                                <span><?php echo $user->getType($row['type']);   ?>  </span>
                                </div>
                                <div class="col-lg-4 d-flex justify-content-center mb-3">
                                    <span class="text-info"> ادرس : </span>
                                ...
                                <div class="col-lg-12 d-flex justify-content-center align-items-center" >
                                    <a class="btn btn-info mb-0 mt-5" style="font-size: 14px;" href="add-edit.php">  تعداد مشتریان : <strong><?php echo $user->getCunt($row['id']);?></strong> </a> 
                                </div>
